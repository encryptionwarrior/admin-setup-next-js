...
export default function SearchInput({className}: {className?: string}) {
  ...
  return (
    <div className='w-full space-y-2'>
      <Button
        variant='outline'
        className={`bg-background text-muted-foreground relative h-9 w-full justify-start rounded-[0.5rem] text-sm font-normal shadow-none sm:pr-12 md:w-40 lg:w-64 ${className}`}
